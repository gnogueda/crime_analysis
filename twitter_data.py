...
cities = ["new york city", "los angeles", "chicago", "houston", "phoenix", "san antonio", "philadelphia", "san diego", "dallas", "austin"]
...
def tweets_scraping(vocabulary):
    ...
    end_date = dt.datetime(year, 3, 14) # This is feb 3
    save_dir = './'
